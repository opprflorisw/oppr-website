...
export function ExamplesPageHeader() {
  return (
      ...
      <div className="container-wide relative z-10">
        <AnimatedSection className="text-center max-w-[720px] mx-auto">
          ...
          <p className="text-lg text-text-secondary leading-relaxed max-w-[600px] mx-auto">
            Real scenarios showing how human observations change outcomes. Each
            example shows what happens with and without the ability to capture
            and correlate operator knowledge.
          </p>
        </AnimatedSection>
      </div>
    </header>
